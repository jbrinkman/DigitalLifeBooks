...
using DotNetNuke.Modules.Event.Data;

namespace DotNetNuke.Modules.Event.Data
{
    public class LoadControlsDao : DataProvider
    {
        ...
        public Array GetChildData(string ChildId, string mid, string tabId, string action)
        {
            ...
            if (action == "Redirect")
            {
               ...
               eventsURL = Globals.NavigateURL(Int32.Parse(tabId), "Events", new string[] { "mid=" + mid, "childId=" + ChildId });
               eventsURL = UrlUtils.PopUpUrl(eventsURL, null, Globals.GetPortalSettings(), false, false);
            }
