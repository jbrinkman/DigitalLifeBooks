...
//    });
    ...
    $('#btnCreateNewEvent').click(function () {
        ...
        jQuery.ajax({
            type: "POST",
            url: "/DesktopModules/Event/API/Edit.ashx/InsertEvent",
            async: false,
            data: parms,
            dataType: "text",
...
//    jQuery.ajax({
//        type: "POST",
//        url: "/DesktopModules/Event/API/Edit.ashx/GetChildren",
//        async: false,
//        data: {},
//        dataType: "json",
//        success: function (response) {
...
function GetChildContent() {
    ...
    jQuery.ajax({
        type: "POST",
        url: "/DesktopModules/Event/API/Edit.ashx/GetChildContent",
        async: false,
        data: parms,
        dataType: "text",
        success: function (response) {
...
function GetEvents() {
    ...
    jQuery.ajax({
        type: "POST",
        url: "/DesktopModules/Event/API/Edit.ashx/GetEvents",
        async: false,
        data: parms,
        dataType: "json",
        success: function (response) {
...
function GetChildData() {
    ...
    jQuery.ajax({
        type: "POST",
        url: "/DesktopModules/Event/API/Edit.ashx/GetChildData",
        async: false,
        data: parms,
        dataType: "json",
        success: function (response) {
