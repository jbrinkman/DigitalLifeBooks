...
namespace DotNetNuke.Modules.DigitalLifeBooks
{
    ...
    /// are accessible to your module's controls (that inherity from DigitalLifeBooksModuleBase
    /// 
    /// </summary>

    public class DigitalLifeBooksModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
