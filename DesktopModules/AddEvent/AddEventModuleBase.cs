...
namespace DotNetNuke.Modules.AddEvent
{
    ...
    /// are accessible to your module's controls (that inherity from AddEventModuleBase
    /// 
    /// </summary>

    public class AddEventModuleBase : DotNetNuke.Entities.Modules.PortalModuleBase
    {
    }
}
